...
SWIFT_CLASS("_TtC14RadioCollector11AppDelegate")
...
SWIFT_CLASS("_TtC14RadioCollector15LoginController")
...
@interface UIColor (SWIFT_EXTENSION(RadioCollector))
- (nonnull instancetype)initWithR:(CGFloat)r g:(CGFloat)g b:(CGFloat)b;
@end


SWIFT_CLASS("_TtC14RadioCollector14ViewController")
